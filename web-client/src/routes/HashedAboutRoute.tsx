    ...
    <section className="mx-auto mt-10 w-full max-w-6xl pb-16 sm:mt-14 sm:pb-24">
      ...
      <motion.section {...fadeConfig(reducedMotion, 0.34)} className="mt-10 grid gap-8 md:grid-cols-2">
        ...
        <article className="participant-card">
          ...
          <p>
          Another layer of this work lies in software development, as this system required specific, custom software to handle the ins and outs of the performance, including a beat pad performer app surface, a website, a backend and database, and a centralized harness mac app which handles transport, ML training and performance, MIDI, virtual and physical audio channel assignments, DAW control, digital signal processing, sample banks, timeline, and communication and interoperability between every other software, hardware, and network layer.
          </p>
          <p>
